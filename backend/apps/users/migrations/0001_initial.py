    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Уникальное имя пользователя. Должно содержать только латинские буквы, цифры и подчёркивания. Минимум 2 символов(а).', max_length=150, unique=True, validators=[django.core.validators.MinLengthValidator(2, message='Имя пользователя не может быть короче 2 символов(а)'), django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='имя пользователя')),
                ...
                ('avatar', models.ImageField(blank=True, default='', help_text='Загрузите фото в формате jpg, jpeg, png. Максимальный размер: 5МБ.', upload_to=apps.core.services.get_upload_path, validators=[django.core.validators.FileExtensionValidator(('jpg', 'jpeg', 'png'), 'Недопустимое расширение файла. Разрешены: jpg, jpeg, png'), apps.core.validators.validate_safe_filename, apps.core.validators.validate_file_size], verbose_name='аватар')),
