    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(help_text='Пользователь, у которого есть список избранного.', on_delete=django.db.models.deletion.CASCADE, related_name='favorite', to=settings.AUTH_USER_MODEL, verbose_name='пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Дата и время создания записи', verbose_name='создано')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Дата и время последнего изменения записи', verbose_name='обновлено')),
                ('favorite', models.ForeignKey(help_text='Список избранного, к которому относится этот элемент.', on_delete=django.db.models.deletion.CASCADE, related_name='items', to='users.favorite', verbose_name='избранное')),
                ('recipe', models.ForeignKey(help_text='Рецепт, добавленный в избранное.', on_delete=django.db.models.deletion.CASCADE, related_name='favorited_by', to='recipes.recipe', verbose_name='рецепт')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='subscribe',
            constraint=models.CheckConstraint(check=models.Q(('user__exact', models.F('author')), _negated=True), name='prevent_self_subscribe'),
        ),
        migrations.AddConstraint(
            model_name='favoriteitem',
            constraint=models.UniqueConstraint(fields=('favorite', 'recipe'), name='unique_favorite_recipe'),
        ),
        migrations.AddIndex(
            model_name='favorite',
        ...
        migrations.AddConstraint(
            model_name='customuser',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('first_name', ''), _negated=True), models.Q(('last_name', ''), _negated=True)), name='first_last_name_not_empty'),
        ),
        migrations.AddConstraint(
            model_name='customuser',
